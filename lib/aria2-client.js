...
class Aria2Client {
  ...
  /**
   * Add a download from a .torrent file's content.
   * @param {string} torrentBase64 - base64-encoded .torrent file bytes
   * @param {object} [options={}] - aria2 options (e.g. { dir })
   * @returns {Promise<string>} GID
   */
  async addTorrent(torrentBase64, options = {}) {
    return this.call('addTorrent', torrentBase64, [], options);
  }
